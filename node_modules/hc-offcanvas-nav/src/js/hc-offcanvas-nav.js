      ...
      const Plugin = function() {
        ...
        const createNavDom = (reinit) => {
          ...
          function createDom(menu, $container, level, title, backIndex) {
            ...
            // decorative TDC coloured bars
            // $content.append(`<div class="d-flex fixed-bottom bg-dark p-1"><div class="bg-pink w-100 m-1" style="height: 8px;"></div><div class="bg-purple w-100 m-1" style="height: 8px;"></div><div class="bg-blue w-100 m-1" style="height: 8px;"></div></div>`);
