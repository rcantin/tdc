...
.hc-offcanvas-nav.nav-levels-overlap ul .nav-wrapper {
  ...
  height: 100%;
  visibility: hidden;
  -webkit-transition: visibility 0s ease 0.2s, -webkit-transform 0.2s ease;
  transition: visibility 0s ease 0.2s, -webkit-transform 0.2s ease;
  transition: visibility 0s ease 0.2s, transform 0.2s ease;
  transition: visibility 0s ease 0.2s, transform 0.2s ease, -webkit-transform 0.2s ease;
}
...
.hc-offcanvas-nav h2 {
  font-family: 'You Are Loved', 'Roboto Condensed', Arial, sans-serif !important;
  font-size: 24px;
