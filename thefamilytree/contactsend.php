...
/* Configuration */
$subject = 'Family Tree Website Inquiry';
...
$body = "
<h3>Family Tree Website Inquiry</h3>
...
// $success = "
// <div class=\"h5 text-success text-center pt-2\"><i class=\"fa fa-check-circle fa-lg\"></i> Message sent successfully!</div>
// <div class=\"text-dark text-center pt-2 font-weight-light\">Thanks for your inquiry.  We will respond using the information you provided.</div>
// ";
...
// $failure = "
// <div class=\"h5 text-danger text-center pt-2\"><i class=\"fa fa-exclamation-circle fa-lg\"></i> Message not sent!</div>
// <div class=\"text-dark text-center p-2 font-weight-light\">Something went wrong while sending your message.  Please try again.  Sorry for the trouble!</div>
// ";
